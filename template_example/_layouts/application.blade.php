...
<head>
    ...
    {!! Html::style('assets/example_template/css/bootstrap.min.css') !!}
    ...
    <![endif]-->
    {!! Html::style('assets/example_template/css/custom.css') !!}
</head>
<body>
...
@yield('content_bottom')
              ...
              {!! Html::script('assets/example_template/js/bootstrap.min.js') !!}
              {!! Html::script('assets/example_template/js/custom.js') !!}
              </body>
              </html>
